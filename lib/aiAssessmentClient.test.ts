        ...
        choices: [
          {
            message: {
              content: JSON.stringify({
                ...
                analystSummary:
                  "AETHER currently reads this window as beneficial now. Recent solar strength and supportive next-day renewables suggest good recharge optionality after evening discharge.",
                fullAnalysisSummary:
